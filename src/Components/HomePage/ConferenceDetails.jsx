        ...
        <div className="row" style={{ boxShadow: '0px 0px 16px 0px #757575b3', padding: '10px', borderRadius: '20px', background: 'white' }}>
          <div className="col-sm-12" style={{ padding: '20px' }}>
            ...
            <p className="u-MarginBottom30 u-xs-MarginBottom30" style={{ textAlign: 'justify', fontSize: '18px' }}>
              IEEE International Conference on Emerging Technologies and Applications 2025 (IEEE MPSec ICETA 2025) is a flagship conference of the IEEE Madhya Pradesh Section Chapter (IEEE Conference number #64837). The conference aims to promote research and networking among academic institutes, R&D institutions, industries and other organisations. The conference is a major step towards the continuous efforts of the IEEE Madhya Pradesh Section towards the promotion of technical acumen and networking within the region. The conference invites papers from authors worldwide, while geographically all editions of the conference would be held within the Madhya Pradesh region. The conference is technically and financially supported by the IEEE MP Section Chapter. All papers presented at the conference will uploaded to IEEE. The conference is being initiated by the Department of Information Technology, ABV-IIITM Gwalior. The future editions of the conference will be held annually on a rotation basis among the collaborating institutions. IEEE ICETA invites papers covering broad topics in the areas of Information Technology, Wireless Communication, Electrical, Computer and Electronics Engineering. This conference will provide an excellent platform for the researchers to present their research work.
            </p>
            <div className="row">
